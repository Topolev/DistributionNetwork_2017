        ...
        public buildCurve(type:string): Curve{
            ...
            switch (type){
                case "POINTSABS": {
                    ...
                    var points = (<PointsAbsCurve> curve).points = [];
                ...
                case "POINTSRELATIVE": {
                    ...
                    var points = (<PointsRelativeCurve> curve).points = [];
                    points.push(new Point(1,1));
                    points.push(new Point(10, 10));
                    break;
                }
                case "EXPRESSION": {
                    ...
                    (<ExpressionCurve> curve).fn = (x) => 0.01*x*x + 1;
                }
            }
            ...
            switch (curveTemplate.type) {
                ...
                case TYPE_CURVE.EXPRESSION: {
                    ...
                    if (curveTemplate.variableDescriptions) {
                        for (let variable of curveTemplate.variableDescriptions) {
