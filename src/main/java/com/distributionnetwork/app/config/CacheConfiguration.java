...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            cm.createCache(com.distributionnetwork.app.domain.User.class.getName(), jcacheConfiguration);
            cm.createCache(com.distributionnetwork.app.domain.Authority.class.getName(), jcacheConfiguration);
            cm.createCache(com.distributionnetwork.app.domain.User.class.getName() + ".authorities", jcacheConfiguration);
