...
import com.distributionnetwork.app.repository.search.SubCategorySearchRepository;
...
public class SubCategoryResourceIntTest {
    ...
    public void setup() {
        ...
        SubCategoryResource subCategoryResource = new SubCategoryResource(subCategoryRepository, subCategorySearchRepository);
